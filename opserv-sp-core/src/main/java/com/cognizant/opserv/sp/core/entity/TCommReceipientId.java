...
/** 
 * The primary key class for the TCommReceipientId Pojo. 
 *
 */
@Embeddable
public class TCommReceipientId implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TCommReceipientId)) {
			return false;
		}
		TCommReceipientId castOther = (TCommReceipientId) other;
