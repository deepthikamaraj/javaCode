 ...
 */
@Embeddable
public class TRptConfigTPersId implements Serializable {
	 ...
	 * @generated
	 */
	public void setRptConfigId(Integer rptConfigId) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TRptConfigTPersId)) {
			return false;
		}
		TRptConfigTPersId castOther = (TRptConfigTPersId) other;
	...
	public String toString() {
		...
		buffer.append("rptId=[").append(rptConfigId).append("] ");
