...
/** 
 * The primary key class for the TRptPublisherId Pojo. 
 *
 */
@Embeddable
public class TRptPublisherId implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TRptPublisherId)) {
			return false;
		}
		TRptPublisherId castOther = (TRptPublisherId) other;
