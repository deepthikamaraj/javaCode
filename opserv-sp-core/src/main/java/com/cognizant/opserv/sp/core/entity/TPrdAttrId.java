...
/** 
 * The primary key class for the TPrdAttrId Pojo. 
 *
 */
@Embeddable
public class TPrdAttrId implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TPrdAttrId)) {
			return false;
		}
		TPrdAttrId castOther = (TPrdAttrId) other;
