...
/** 
 * JPA class representing TLoadLog 
 * The corresponding mapping table is t_load_log 
 */

@Entity
@NamedQueries({
		@NamedQuery(name = "FindAllTLoadLogs", query = "select myTLoadLog from TLoadLog myTLoadLog"),
		@NamedQuery(name = "CountTLoadLogs", query = "Select Count(c) from TLoadLog c"),
		@NamedQuery(name = "FindTLoadLogByTTerrZipLoad", query = "select myTLoadLog from TLoadLog myTLoadLog where myTLoadLog.tTerrZipLoad = ?1 "),
		@NamedQuery(name = "CountTLoadLogsByTTerrZipLoad", query = "select Count(myTLoadLog) from TLoadLog myTLoadLog where myTLoadLog.tTerrZipLoad = ?1 "),
		@NamedQuery(name = "FindTLoadLogByDataSetID", query = "select  myTLoadLog from TLoadLog myTLoadLog where myTLoadLog.tTerrZipLoad.dsId = ?1 and myTLoadLog.tenantId = ?2 ")})
@Table(name = "t_load_log", uniqueConstraints = @UniqueConstraint(columnNames = { "log_id" }))
public class TLoadLog implements Serializable {
	...
	@Valid
	private TTerrZipLoad tTerrZipLoad;
	 ...
	 * @generated
	 */
	public TTerrZipLoad getTTerrZipLoad() {
		return this.tTerrZipLoad;
	}
	 ...
	 * @generated
	 */
	public void setTTerrZipLoad(final TTerrZipLoad tTerrZipLoad) {
		this.tTerrZipLoad = tTerrZipLoad;
	 ...
	 * @generated
	 */
	public void copy(final TLoadLog that) {
	...
	public boolean equals(final Object obj) {
		...
		final TLoadLog other = (TLoadLog) obj;
		if (logId == null) {
			if (other.logId != null) {
				return false;
			}
