...
/** 
 * JPA class representing TBelgiumZip 
 * The corresponding mapping table is t_belgium_zip 
 */

@Entity
@NamedQueries({
		@NamedQuery(name = "FindAllTBelgiumZips", query = "select myTBelgiumZip from TBelgiumZip myTBelgiumZip"),
		@NamedQuery(name = "CountTBelgiumZips", query = "Select Count(c) from TBelgiumZip c")
//		,
//		@NamedQuery(name = "FindTBelgiumZipByTUsaCounty", query = "select myTBelgiumZip from TBelgiumZip myTBelgiumZip where myTBelgiumZip.tUsaCounty = ?1 "),
//		@NamedQuery(name = "CountTBelgiumZipsByTUsaCounty", query = "select Count(myTBelgiumZip) from TBelgiumZip myTBelgiumZip where myTBelgiumZip.tUsaCounty = ?1 ")
		})
@Table(name = "t_belgium_zip", uniqueConstraints = @UniqueConstraint(columnNames = { "zip_id" }))
public class TBelgiumZip implements Serializable {
...
//	}
	 ...
	 * @generated
	 */
	public void copy(final TBelgiumZip that) {
...
//		buffer.append("pointZipFlag=[").append(pointZipFlag).append("] ");
	...
	public boolean equals(final Object obj) {
		...
		final TBelgiumZip other = (TBelgiumZip) obj;
		if (zipId == null) {
			if (other.zipId != null) {
				return false;
			}
