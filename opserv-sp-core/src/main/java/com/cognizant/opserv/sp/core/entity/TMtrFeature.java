...
/** 
 * JPA class representing TMtrFeature 
 * The corresponding mapping table is t_mtr_feature 
 */

@Entity
@NamedQueries({
		@NamedQuery(name = "FindAllTMtrFeatures", query = "select myTMtrFeature from TMtrFeature myTMtrFeature"),
		@NamedQuery(name = "CountTMtrFeatures", query = "Select Count(c) from TMtrFeature c") })
@Table(name = "t_mtr_feature", uniqueConstraints = @UniqueConstraint(columnNames = { "feature_id" }))
public class TMtrFeature implements Serializable {
	 ...
	 * @generated
	 */
	public void copy(final TMtrFeature that) {
	...
	public boolean equals(final Object obj) {
		...
		final TMtrFeature other = (TMtrFeature) obj;
		if (featureId == null) {
