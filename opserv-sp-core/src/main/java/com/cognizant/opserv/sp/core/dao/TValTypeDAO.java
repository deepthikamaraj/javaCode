...
/**
 * Interface represents API's of TValType DAO.
 * 
 * @author JCoE team
 * @version 1.0
 * 
 */
public interface TValTypeDAO {
	 ...
	 */
	TValType createTValType(TValType tValType);
	 ...
	 */
	void deleteTValType(Integer valTypeId);
	 ...
	 * @return tValType Persisted TValType object
	 */
	TValType updateTValType(TValType tValType);

	/**
	 * Retrieve an TValType object based on given valTypeId.
	 * 
	 * @param valTypeId
	 ...
	 *         not found
	 */
	TValType findTValTypeById(Integer valTypeId);
	 ...
	 */
	List<TValType> findTValTypes(SearchFilter<TValType> searchFilter);

	/**
	 * Count TValType based on given search criteria using Dynamic JPAQL.
	 * 
	 * @param searchFilter
	 *            The query criteria and search filter conditions are set
	 * @return a Object indicating the count
	 */
	Object countTValTypes(SearchFilter<TValType> searchFilter);
	 ...
	 *         criteria. Returns null if not found
	 */
	List<TValType> getTValTypesByTAttrDataType(SearchFilter<TAttrDataType> searchFilter);
	 ...
	 * @return a Object indicating the count
	 */
	Object countTValTypesByTAttrDataType(SearchFilter<TAttrDataType> searchFilter);
