...
/** 
 * JPA class representing TChngReqFeature 
 * The corresponding mapping table is t_chng_req_feature 
 */

@Entity
@NamedQueries({
		@NamedQuery(name = "FindAllTChngReqFeatures", query = "select myTChngReqFeature from TChngReqFeature myTChngReqFeature"),
		@NamedQuery(name = "CountTChngReqFeatures", query = "Select Count(c) from TChngReqFeature c") })
@Table(name = "t_chng_req_feature", uniqueConstraints = @UniqueConstraint(columnNames = { "feature_id" }))
public class TChngReqFeature implements Serializable {
...
/*
	@OneToMany(cascade = { CascadeType.REFRESH, CascadeType.PERSIST, CascadeType.MERGE }, mappedBy = "tChngReqFeature")
	private Set<TChngReqTrigger> tChngReqTriggers;*/
	
	/**
	 *
	 * @generated
	 */
	public TChngReqFeature() {
	}
	 ...
	 * @generated
	 */
	public void copy(final TChngReqFeature that) {
	...
	public boolean equals(final Object obj) {
		...
		final TChngReqFeature other = (TChngReqFeature) obj;
		if (featureId == null) {
